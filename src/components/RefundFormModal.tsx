...
export const RefundFormModal: React.FC<RefundFormModalProps> = ({
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // html2pdf.js configuration requested to fit the entire form on a single A4 page without cropping
      const opt = {
      ...
      try {
        ...
        console.warn('Direct html2pdf run encountered error, executing fallback...', directErr);
        // Robust fallback using html2canvas & jsPDF with matching settings
